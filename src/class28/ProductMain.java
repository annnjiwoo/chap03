...
public class ProductMain {
	public static void main(String[] args) {
		...
		// 객체의 필드에 직접 접근해서 값을 갖고올 수 없음
		// System.out.println(product.id);
		// System.out.println(product.name);
		// System.out.println(product.price);

		// 객체의 값을 갖고 올 수 있는 setter 메소드를 통해서 값조회
	...
	// 상품 클래스 객체 생성 메소드
	private static void printProduct(Product[] productArr) { // 시그너처, 메소드의 윤곽 , 괄호 안에 있는 값은 참조값이라 주소가 출력됨
